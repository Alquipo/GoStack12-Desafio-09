...
<img alt="GitHub language count" src="https://img.shields.io/github/languages/count/Alquipo/GoStack12-desafio-09">

<img alt="Repository size" src="https://img.shields.io/github/repo-size/Alquipo/GoStack12-desafio-09">
...
Nesse desafio, criei uma nova aplicação para aprender novas coisas e treinar o que tinha aprendido até agora no Node.js junto ao TypeScript, incluindo o uso de banco de dados com o TypeORM, e relacionamentos ManyToMany!
...
$ git clone https://github.com/Alquipo/GoStack12-desafio-09

# Acesse a pasta do projeto no terminal/cmd
$ cd GoStack12-desafio-09
```
